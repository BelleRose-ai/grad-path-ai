...
const LoadingSpinner: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center my-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="text-lg font-semibold text-slate-700">Evaluating your profile...</p>
